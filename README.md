...
**Note:** For new projects, you may want to usethe updated 3.x beta of [Microsoft.ApplicationInsights.NLogTarget](https://www.nuget.org/packages/Microsoft.ApplicationInsights.NLogTarget) instead. Once it's final, this package will likely be redundant and will potentiall be deprecated.
